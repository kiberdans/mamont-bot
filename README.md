...
- **Учёт сообщений**: каждое сообщение, состоящее только из 🦣 (плюс пробелы и переносы строк), даёт +1 мамонт автору.
...
- **Требование статуса**: считаются только пользователи из белого списка или с нужным текстом в кастомном статусе.
